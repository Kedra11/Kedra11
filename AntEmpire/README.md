...
- **Профессии** — воины (патруль, ближний бой ×3, прикрывают рабочих
  от ударов паука) и разведчики (бродят далеко, находят золотые листья
  и мёд — разовые богатые источники).
- **Rain event** — периодический дождь: все замедляются, мир темнеет.
- **Tunnel Hub** — комната за Soil (+узлы почвы на карте): +6% скорости
  всех муравьёв за уровень, тоннели видны в разрезе муравейника.
- **Эволюция королевы** — 5 уровней (Food+DNA): +2 населения и +8%
  скорости рождения за уровень, королева растёт и золотеет.
